...
package org.apache.spark.graphxp.lib

import org.apache.spark.SparkFunSuite

import org.apache.spark.graphx.LocalSparkContext
import org.apache.spark.graphxp._
import org.apache.spark.graphxp.util.GraphGenerators
...
class PageRankSuite extends SparkFunSuite with LocalSparkContext {
  ...
  test("Star PageRank") {
    withSpark { sc =>
      ...
      /*
      starGraph.vertices.partitionsRDD.foreach { part =>
        // part.index.iterator.foreach(v => print(v + " "))
        println(part.values.size)
        println
      }
      */
      /*
