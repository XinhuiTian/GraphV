 ...
 * [[graphxp.EdgeRDD]]. Vertex attributes may be partially shipped to construct a
...
class ReplicatedVertexView[VD: ClassTag, ED: ClassTag](
   ...
   */
  def upgrade(vertices: graphxp.VertexRDD[VD], includeSrc: Boolean, includeDst: Boolean) {
   ...
   */
  def withActiveSet(actives: graphxp.VertexRDD[_]): ReplicatedVertexView[VD, ED] = {
   ...
   */
  def updateVertices(updates: graphxp.VertexRDD[VD]): ReplicatedVertexView[VD, ED] = {
